...
int ip_recv(struct rte_mbuf *m_buf, struct rte_ether_hdr *eh,
  ...
  struct rte_ipv4_hdr *iph =
      (struct rte_ipv4_hdr *)((unsigned char *)(eh) +
                              RTE_ETHER_HDR_LEN);
...
int ip_send(xy_ip_socket *ip_sk, struct rte_mbuf *m_buf,
  ...
  iph->version_ihl;         // TODO /**< version and header length */
  iph->type_of_service;     // TODO /**< type of service */
  iph->total_length;        // TODO /**< length of packet */
  iph->packet_id;           // TODO /**< packet ID */
  iph->fragment_offset;     // TODO /**< fragmentation offset */
  iph->time_to_live = ttl;  // TODO	/**< time to live */
  iph->next_proto_id =
      next_proto_id;      /**< tcp: iph->next_proto_id == 6 */
  iph->hdr_checksum = 0;  // TODO /**< header checksum */
